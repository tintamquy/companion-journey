...
export const Login = () => {
  ...
  const { login, signInWithGoogle, loading, error, clearError } = useAuthStore()
  ...
  const getErrorMessage = (errorMessage: string): string => {
    if (errorMessage.includes('user-not-found')) return t('auth.errors.userNotFound')
    if (errorMessage.includes('wrong-password')) return t('auth.errors.wrongPassword')
      ...
      >
        <div className="glass p-8 rounded-3xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Your path to recovery</p>
          </div>
